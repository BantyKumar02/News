    ...
    <div className="min-h-screen bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 p-6">
      ...
      <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-8 max-w-6xl mx-auto">
        {newsData.map((news: any, index) => (
          <div
            key={index}
            className="bg-blue-50 shadow-lg rounded-lg overflow-hidden border border-red-700 transition-transform duration-300 transform hover:-translate-y-3 hover:shadow-[0_10px_20px_rgba(0,0,255,0.4)]"
          >
            <Image
            ...
            <div className="p-5">
              ...
              <a href={news.url} target="_blank" rel="noopener noreferrer">
                <button className="mt-3 px-5 py-2 bg-blue-600 text-white rounded-md hover:bg-red-700 transition duration-300">
                  Read More →
                </button>
              </a>
            </div>
